...
public class HDFSApp {
    ...
    public void copyToLocalFile() throws Exception {
        Path localPath = new Path("E:\\IDEA\\stockPortrait\\src\\test\\resources");
        Path hdfsPath = new Path("/share_data/today_trade20190322.csv");
    ...
    public void listFiles() throws Exception {
        FileStatus[] fileStatuses = fileSystem.listStatus(new Path("/share_data"));
    ...
    public void setUp() throws Exception {
        System.out.println("com.HDFSApp.setUp");
    ...
    public void tearDown() throws Exception {
        ...
        System.out.println("com.HDFSApp.tearDown");
    }
